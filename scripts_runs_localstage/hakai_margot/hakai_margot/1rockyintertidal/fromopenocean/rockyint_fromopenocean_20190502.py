# track backwards rocky intertidal for hakai
...
for i in range(num_steps):
    o.seed_from_shapefile(r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\hakai_margot\spatial\hakai_margot_reproject\hakai_polys_1rockyintertidal.shp', number=2000, time=reader_hakai.end_time - (num_steps * time_step) + i*time_step)
...
import numpy as np
np.save(r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\hakai_margot\hakai_margot\1rockyintertidal\fromopenocean\output\lon_2.npy', o.elements_scheduled.lon)
np.save(r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\hakai_margot\hakai_margot\1rockyintertidal\fromopenocean\output\lat_2.npy', o.elements_scheduled.lat)
...
o.run(end_time=reader_hakai.start_time, time_step=-30, time_step_output=1800,
      outfile=r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\hakai_margot\hakai_margot\1rockyintertidal\fromopenocean\output\rockyint_20190501_2.nc', export_variables=["age_seconds", "land_binary_mask"])
print o
...
#o.io_import_file(r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\hakai_margot\hakai_margot\1rockyintertidal\fromopenocean\output\rockyint_20190501_1.nc')