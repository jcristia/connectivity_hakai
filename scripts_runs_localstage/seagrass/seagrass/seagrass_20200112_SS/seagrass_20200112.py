...
# test run using minimum particles and only 10 days
...
sg_path = r'/home/jcristia/runs/seagrass_20200112/seagrass_split'
...
for shp in shapefiles:
    ...
    o.run(end_time=reader_salish.end_time - timedelta(days=50), time_step=30, time_step_output=1800,
