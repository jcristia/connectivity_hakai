...
##### times ######
# this is a separate piece from the above
# I noticed later that the times were screwed up in the new file
# rather then run it all over, I will just overwrite the times in the new file
# with those from the old
file_original = r'D:\Hakai\fvcom_results\cal03brcl_21_0003.nc'
dataset = nc.Dataset(file_original, "r+")
times_original = dataset.variables["time"][:]
file_new = r'D:\Hakai\fvcom_results\cal03brcl_21_0003_EDITED.nc'
dataset = nc.Dataset(file_new, "r+")
dataset.variables["time"][:] = times_original
