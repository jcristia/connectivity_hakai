...
for i in range(num_steps):
    o.seed_from_shapefile(r'hakai_polys_1rockyintertidal.shp', number=2000, time=reader_hakai.start_time + i*time_step)
...
o.run(end_time=reader_hakai.end_time, time_step=30, time_step_output=1800,
      outfile=r'outputs/rockyint_20190501_1.nc', export_variables=["age_seconds", "land_binary_mask"])
print o
#o.plot()
#o.animation()
