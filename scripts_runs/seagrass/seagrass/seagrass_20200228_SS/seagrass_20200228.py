...
sg_path = r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\seagrass\seagrass\seagrass_20200228_SS\seagrass_split'
...
for shp in shapefiles:
    ...
    np.save('seagrass_20200228_SS/outputs/lon_' + base + '.npy', o.elements_scheduled.lon)
    np.save('seagrass_20200228_SS/outputs/lat_' + base + '.npy', o.elements_scheduled.lat)
    ...
    o.run(end_time=reader_salish.end_time, time_step=60, time_step_output=1800,
          outfile=r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_runs\seagrass\seagrass\seagrass_20200228_SS\outputs\seagrass_' + base + '.nc', export_variables=["age_seconds", "land_binary_mask"])
