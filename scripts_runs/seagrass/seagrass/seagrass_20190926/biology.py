...
sg_path = r'/home/jcristia/runs/seagrass_20190926/seagrass_split' # where input shapefiles are stored
...
input_folder = r'/home/jcristia/runs/seagrass_20190926/outputs' # where nc and npy files are output
output_folder = r'/home/jcristia/runs/seagrass_20190926/outputs/shp' # where to save shp outputs from this script
seagrass_og = r'/home/jcristia/runs/seagrass_20190926/seagrass_og/seagrass_all_17FINAL.shp' # we still need the full original seagrass dataset for other checks even if we are using split up versions
seagrass_buff = r'/home/jcristia/runs/seagrass_20190926/seagrass_buff/seagrass_buff_10FINAL.shp'  # buffered by 100m just for checking settlement. This is to account for seagrass polys that have slivers between coastline
