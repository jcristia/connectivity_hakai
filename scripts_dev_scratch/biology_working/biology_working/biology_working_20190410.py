...
seagrass_buff = r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts\biology_working\seagrass_working\seagrass_working_erase_buff20.shp' # buffered by 20m just for checking settlement. This is to account for seagrass polys that have slivers between coastline
...
# output shapefile name and location
shp_out = r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts\biology_working\output\shp\dest_biology_pts_20190410_test'
conn_lines_out = r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts\biology_working\output\shp\connectivity_20190410_test'
...
def get_destination_coords(origin_dest, traj, lon, lat, timestep, seagrass_crs):
    ...
    time_steps = []
    for i in range(len(traj)):
        lons_dest.append(lon[i][lon[i].mask==False][-1])
...
def connection_lines(shp_out, seagrass, seagrass_crs, conn_lines_out):
    ...
    def CircleCoords(xLeft, yCenter, r, n): # credit: MGET. Also, see circle_coords.xls for explanation of equation.
