...
file_salish_cluster = r'D:\Hakai\models\salishsea\salishseacast\forcing\SalishSea_1h_20170101_20170316_opendrift.nc'
...
sg_path = r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_dev_scratch\biology_working\biology_working\seagrass_20200403_ISSUE\seagrass_split'
...
for shp in shapefiles:
    ...
    np.save('seagrass_20200403_ISSUE/outputs/lon_' + base + '.npy', o.elements_scheduled.lon)
    np.save('seagrass_20200403_ISSUE/outputs/lat_' + base + '.npy', o.elements_scheduled.lat)
    ...
    o.run(end_time=reader_salish.end_time, time_step=60, time_step_output=1800,
          outfile=r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_dev_scratch\biology_working\biology_working\seagrass_20200403_ISSUE\outputs\seagrass_' + base + '.nc', export_variables=["age_seconds", "land_binary_mask"])
